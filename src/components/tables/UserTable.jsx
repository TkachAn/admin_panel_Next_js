...
import ConfirmModal from "@/comp/admin/modal/confirm";
import ErrorModal from "@/comp/admin/modal/errorDel";
import AddUser from "@/comp/admin/modal/winsdow";
...
<UserPlus size={24} /> 
        ...
        <NormButton children={"+ Добавить нового пользователя "} onClick={() => setIsOpen(true)}/>
      </div>
