...
import styles from "@/comp/admin/modal/styles.module.css";
import GardenPlotForm from "@/components/forms/gem";

export default function AddOwner({ isOpen, onClose }) {
  return (
